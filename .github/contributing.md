# Contributing to npm-indexer

First and foremost, thank you! We appreciate that you want to contribute to npm-indexer, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for npm-indexer**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for npm-indexer:

- star the [project](https://github.com/doowb/npm-indexer)
- tweet your support for npm-indexer
...
- **version**: please note the version of npm-indexer are you using
...
[so]: http://stackoverflow.com/questions/tagged/npm-indexer